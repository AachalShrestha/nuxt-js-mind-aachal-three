<template>
  <div class="flex animate-fade animate-once animate-delay-[500ms]">
    ...
    <div class="flex-row pt-5 justify-end pr-5 pb-2">
      <button style="margin-left: 16px" @click="drawer = true" class="bg-white dark:bg-slate-900 bg-opacity-20 hover:bg-opacity-90 dark:bg-opacity-10 z-20">
